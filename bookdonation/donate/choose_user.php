...
<?php
	$query = "SELECT name, message, accountid, requestid FROM bookrequests NATURAL JOIN accounts WHERE isbn = '$isgn' AND sent = 0 AND received = 0 AND returned = 0 ORDER BY date ASC";
